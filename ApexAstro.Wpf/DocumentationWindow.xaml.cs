    ...
    public partial class DocumentationWindow : Window
    {
        ...
        private void LoadDocumentation()
        {
            try
            {
                ...
                string? markdownContent = LoadEmbeddedResource("ApexAstro.Wpf.Documentation.Help.md");
        ...
        private void DisplayFallbackContent()
        {
            ...
            title.Inlines.Add(new Run("ApexAstro Documentation") { FontSize = 18, FontWeight = FontWeights.Bold });
            ...
            content.Inlines.Add(new Run("ApexAstro is a FITS and XISF image viewer and analysis tool for astronomical imaging.\n\n"));
