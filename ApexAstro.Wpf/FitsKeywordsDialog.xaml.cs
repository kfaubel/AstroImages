...
namespace ApexAstro.Wpf
{
    ...
    public partial class FitsKeywordsDialog : Window
    {
        ...
        private static readonly List<(string Keyword, string Description)> CommonFitsKeywords = new()
        {
            ...
            ("ROWORDER", "Row order of image data (TOP-DOWN or BOTTOM-UP)"),
            
            // Astronomical imaging keywords
            ("OBJECT", "Target object name"),
            ("OBJCTRA", "Right ascension of object (HMS string)"),
            ("OBJCTDEC", "Declination of object (DMS string)"),
            ("OBJCTROT", "Object rotation angle in degrees"),
            ("TELESCOP", "Telescope used to acquire data"),
            ("FOCALLEN", "Focal length of telescope in mm"),
            ("FOCRATIO", "Focal ratio of telescope"),
            ...
            ("CAMERAID", "Camera identifier string"),
            ("USBLIMIT", "Camera USB bandwidth limit"),
            ("OBSERVER", "Observer who acquired the data"),
            ("OBSERVAT", "Observatory name"),
            ("SITELAT", "Site latitude in degrees"),
            ("SITELONG", "Site longitude in degrees"),
            ("SITEELEV", "Site elevation in meters"),
            ("DATE-LOC", "Local date/time of observation"),
            ("DATE-OBS", "Date/time of observation (UTC)"),
            ("DATE-AVG", "Averaged midpoint time of observation (UTC)"),
            ("MJD-OBS", "Modified Julian Date of observation start"),
            ("MJD-AVG", "Modified Julian Date of averaged midpoint"),
            ("TIME-OBS", "Time of the observation"),
            ("EXPTIME", "Exposure time in seconds"),
            ("EXPOSURE", "Exposure time in seconds (alternate)"),
            ("FILTER", "Filter name"),
            ("FWHEEL", "Filter wheel name"),
            ("IMAGETYP", "Type of image (LIGHT, DARK, FLAT, BIAS)"),
            ("GAIN", "Sensor gain"),
            ("OFFSET", "Sensor gain offset"),
            ("EGAIN", "Electrons per A/D unit (e-/ADU)"),
            ...
            ("RA", "Right ascension of telescope in degrees"),
            ("DEC", "Declination of telescope in degrees"),
            ("CENTALT", "Altitude of telescope in degrees"),
            ("CENTAZ", "Azimuth of telescope in degrees"),
            ("AIRMASS", "Airmass at frame center"),
            ("PIERSIDE", "Telescope pier side (East/West)"),
            ("FOCNAME", "Focuser name"),
            ("FOCPOS", "Focuser position"),
            ("FOCUSPOS", "Focuser position (NINA alternate)"),
            ("FOCUSSZ", "Focuser step size"),
            ("FOCTEMP", "Focuser temperature in degrees C"),
            ("FOCUSTEM", "Focuser temperature in degrees C (NINA alternate)"),
